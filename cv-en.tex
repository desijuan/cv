...
\linea %%%%%
\icono \textbf{React} client. Responsive with \textbf{Bootstrap}.
...
\vspace{1pt}
\textbf{\icono Weekly meetings with professor Douglas Rodrigues (UFF) in which we study topics in Statistics, Data Science and Machine Learning}. \textit{2021 -- now}.
